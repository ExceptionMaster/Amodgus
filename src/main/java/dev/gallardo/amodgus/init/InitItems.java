...
public class InitItems {
	...
	public static final RegistryObject<Item> RED_TOY = CreativeTabInit
			.addToTab(ITEMS.register("red_toy", () -> new Item(new Item.Properties().stacksTo(1))));
	
	public static final RegistryObject<Item> BLACK_TOY = CreativeTabInit
			.addToTab(ITEMS.register("black_toy", () -> new Item(new Item.Properties().stacksTo(1))));
	
	public static final RegistryObject<Item> WHITE_TOY = CreativeTabInit
			.addToTab(ITEMS.register("white_toy", () -> new Item(new Item.Properties().stacksTo(1))));
	
	public static final RegistryObject<Item> CYAN_TOY = CreativeTabInit
			.addToTab(ITEMS.register("cyan_toy", () -> new Item(new Item.Properties().stacksTo(1))));
	
	public static final RegistryObject<Item> PINK_TOY = CreativeTabInit
			.addToTab(ITEMS.register("pink_toy", () -> new Item(new Item.Properties().stacksTo(1))));
	
	public static final RegistryObject<Item> PURPLE_TOY = CreativeTabInit
			.addToTab(ITEMS.register("purple_toy", () -> new Item(new Item.Properties().stacksTo(1))));
	
	public static final RegistryObject<Item> MAGENTA_TOY = CreativeTabInit
			.addToTab(ITEMS.register("magenta_toy", () -> new Item(new Item.Properties().stacksTo(1))));
	
	public static final RegistryObject<Item> BLUE_TOY = CreativeTabInit
			.addToTab(ITEMS.register("blue_toy", () -> new Item(new Item.Properties().stacksTo(1))));
	
	public static final RegistryObject<Item> BROWN_TOY = CreativeTabInit
			.addToTab(ITEMS.register("brown_toy", () -> new Item(new Item.Properties().stacksTo(1))));
	
	public static final RegistryObject<Item> GREEN_TOY = CreativeTabInit
			.addToTab(ITEMS.register("green_toy", () -> new Item(new Item.Properties().stacksTo(1))));
	
	public static final RegistryObject<Item> LIME_TOY = CreativeTabInit
			.addToTab(ITEMS.register("lime_toy", () -> new Item(new Item.Properties().stacksTo(1))));
	
	public static final RegistryObject<Item> YELLOW_TOY = CreativeTabInit
			.addToTab(ITEMS.register("yellow_toy", () -> new Item(new Item.Properties().stacksTo(1))));
	
	public static final RegistryObject<Item> ORANGE_TOY = CreativeTabInit
			.addToTab(ITEMS.register("orange_toy", () -> new Item(new Item.Properties().stacksTo(1))));

	public static final RegistryObject<Item> FLASK = CreativeTabInit
			.addToTab(ITEMS.register("flask", () -> new Item(new Item.Properties().stacksTo(1))));
	...
	public static final RegistryObject<Item> AMONGUS_DRIP_SONG_MUSIC_DISC = CreativeTabInit
			.addToTab(ITEMS.register("music_disc_amongus_drip",
					() -> new RecordItem(4, ModSounds.AMONGUS_DRIP, new Item.Properties().stacksTo(1), 0)));
}
